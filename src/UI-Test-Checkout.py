...
class TestConfig:
    ...
    CLIENT_ID: str = os.getenv("SC_CLIENT_ID", "bitte die valide Testdaten aus dem PDF Fallaufgabe Softwaretester verwenden")
    CLIENT_SECRET: str = os.getenv("SC_CLIENT_SECRET", "bitte die valide Testdaten aus dem PDF Fallaufgabe Softwaretester verwenden")
    GENERAL_CONTRACT_ID: str = os.getenv("SC_GCR", "bitte die valide Testdaten aus dem PDF Fallaufgabe Softwaretester verwenden")
