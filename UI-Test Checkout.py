...
class TestConfig:
    ...
    CLIENT_ID: str = os.getenv("SC_CLIENT_ID", "9da410fe2fe7077a9e040f687ae83f84")
    CLIENT_SECRET: str = os.getenv("SC_CLIENT_SECRET", "80d8d7785e55e6a0852935396674ed582daf04ff1f038d48a461c94f5219f282")
    GENERAL_CONTRACT_ID: str = os.getenv("SC_GCR", "GCR_AHRMBVBSJXJNHFN45EQ7KKR9W4G2O4")
